...
bob = Person.find_or_create_by!(first_name: 'Bob', last_name: 'B', user: user, gender: 'Male', date_of_birth: Date.new(2017,1,1))
emily = Person.find_or_create_by!(first_name: 'Emily', last_name: 'E', user: user, gender: 'Female', date_of_birth: Date.new(2019,1,1))
...
Fact.find_or_create_by!(id: 104, person: p2, label: 'Occupation', value: 'Teacher at School B', date: Date.new(1994, 9, 1), location: 'School B')
Fact.find_or_create_by!(id: 105, person: p2, label: 'Residence', value: 'Moved to City B', date: Date.new(2010, 1, 1), location: 'City B')
Fact.find_or_create_by!(id: 106, person: alice, label: 'Hobby', value: 'Painting landscapes', date: Date.new(2014, 1, 1), location: 'Home Studio')
...
TimelineItem.find_or_create_by!(id: 204, person: p1, title: 'Married Jane', date: Date.new(1994,6,1), place: 'City A', icon: 'Love', description: 'Married Jane in City A.')
...
TimelineItem.find_or_create_by!(id: 210, person: p2, title: 'Graduated College', date: Date.new(1994,6,1), place: 'School B', icon: 'Graduation', description: 'Graduated from School B.')
TimelineItem.find_or_create_by!(id: 211, person: p2, title: 'Married John', date: Date.new(1994,6,1), place: 'City A', icon: 'Love', description: 'Married John in City A.')
...
TimelineItem.find_or_create_by!(id: 214, person: p2, title: 'Started Teaching', date: Date.new(1994,9,1), place: 'School B', icon: 'Work', description: 'Started teaching at School B.')
...
TimelineItem.find_or_create_by!(id: 218, person: alice, title: 'Started Painting', date: Date.new(2014,1,1), place: 'Home Studio', icon: 'Star', description: 'Began painting landscapes.')
...
TimelineItem.find_or_create_by!(id: 229, person: david, title: 'Started at Company X', date: Date.new(2015,9,1), place: 'Company X HQ', icon: 'Work', description: 'Started as Senior Engineer at Company X.')
...
TimelineItem.find_or_create_by!(id: 231, person: bob, title: 'Born', date: Date.new(2017,1,1), place: 'City A', icon: 'Birthday', description: 'Bob was born in City A.')
...
TimelineItem.find_or_create_by!(id: 235, person: emily, title: 'Born', date: Date.new(2019,1,1), place: 'City A', icon: 'Birthday', description: 'Emily was born in City A.')
TimelineItem.find_or_create_by!(id: 236, person: emily, title: 'Started Preschool', date: Date.new(2024,9,1), place: 'City A', icon: 'Graduation', description: 'Started at Little Stars Preschool.')
TimelineItem.find_or_create_by!(id: 237, person: emily, title: 'Favorite Toy', date: Date.new(2024,2,14), place: 'Home', icon: 'Star', description: 'Got her favorite teddy bear for her 5th birthday.')
...
TimelineItem.find_or_create_by!(id: 239, person: charlie, title: 'Graduated High School', date: Date.new(2015,6,1), place: 'City A High', icon: 'Graduation', description: 'Graduated from City A High School.')
TimelineItem.find_or_create_by!(id: 240, person: charlie, title: 'Started College', date: Date.new(2015,9,1), place: 'Music College', icon: 'Graduation', description: 'Started studying music at college.')
# --- MEDIA ---
# Images
